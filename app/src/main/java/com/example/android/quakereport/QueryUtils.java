...
public final class QueryUtils {
    ...
    /**
     * Query the USGS dataset and return an {@link List<Earthquake>}'s.
     */
     ...
     */
    public static List<Earthquake> extractEarthquakes(String json) {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); ++i) {
                ...
                earthquakes.add(new Earthquake(place, magnitude, timestamp, url));
            }
